...
const BillCalculator = ({
  ...
  const calculateBill = (e) => {
    ...
    const getGrossPayment = totalWeight && totalWeight * parseInt(bidPrice);
    ...
    // console.log("comm", commissionResult);
    // console.log("fair", fareResult);
    // console.log("labour", labourResult);
    // console.log("cler", clerkFee);
    // console.log("mark", marketFee);
  ...
  const getTotal = () => {
    ...
    console.log("cw ", currentWeightVar);
  ...
  return (
    <div className='container-fluid'>
      ...
      <form onSubmit={calculateBill} className='mt-4'>
        ...
        <Row className='my-2'>
          <Form.Group as={Col} md={3}>
            <Form.Label>Fare (₨ Per Nagg)</Form.Label>
            <Form.Control
              type='number'
              value={inputFare}
          ...
          <Form.Group as={Col} md={3}>
            <Form.Label>Labour (₨ Per Nagg)</Form.Label>
            <Form.Control
              type='number'
              value={inputLabour}
        ...
        <Row className='my-2 justify-content-center'>
          ...
          <Card as={Col} md={3} bg='info' text='dark' className='m-1'>
            <Card.Body className='px-1 py-1 d-flex justify-content-center align-items-center flex-column'>
              <Card.Text>Total nagg</Card.Text>
              <Card.Title style={{ fontSize: "40px" }}>
        ...
        <Row className='my-2'>
          <h5 className=' text-center'>Weight (Per Nagg)</h5>
